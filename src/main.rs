...
fn main() {
    ...
    for j in (0..ysize).rev() {
        for i in 0..xsize {
            ...
            let red: usize = (259.99 * color_multipliers.r()) as usize;
            let green: usize = (259.99 * color_multipliers.g()) as usize;
            let blue: usize = (259.99 * color_multipliers.b()) as usize;
